        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item active">
                    <router-link class="nav-link" data-toggle="collapse" data-target="#navbarSupportedContent" to="/blogs">
                        Blogs
                    </router-link>
                </li>
                <li class="nav-item">
                    <router-link class="nav-link" data-toggle="collapse" data-target="#navbarSupportedContent" to="/blogs/new">
                        New Blog
                    </router-link>
                </li>
            </ul>
            <ul class="navbar-nav">
                <template v-if="!username">
                    ...
                    <li class="nav-item">
                        <router-link class="nav-link" data-toggle="collapse" data-target="#navbarSupportedContent" to="/user/signup">
                            Sign Up
                        </router-link>
                    </li>
                </template>
